    ...
    return (
        <Popover className='relative'>
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] rounded-xl shadow-box overflow-hidden">
                ...
                <div className="h-px w-[89%] bg-[#2f3336] my-0.5 mx-auto"/>

                <Disclosure>
                    {({open}) => (
                        <>
                        <Disclosure.Button className="w-full h-[52px] px-4 flex justify-between items-center font-bold hover:bg-[#eff3f41a] transition-colors">
                            Creator Studio
                        ...
                        <Disclosure.Panel>
                            <Link to="/" className="h-11 flex items-center px-3 gap-3 text-[15px] font-medium hover:bg-[#eff3f41a] transition-colors">
                    ...
                    {({open}) => (
                        ...
                        <Disclosure.Panel>
                            ...
                            <button
                                ...
                                className="h-11 flex items-center w-full px-3 gap-3 text-[15px] font-medium hover:bg-[#eff3f41a] transition-colors"
                            >
                                <svg width={18.75} height={18.75}
                                    viewBox="0 0 24 24">
