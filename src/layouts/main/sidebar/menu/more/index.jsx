...
export default function More() {
    return (
        <Popover className='relative'>
            <Popover.Button className="py-[2px] w-full text-left group outline-none">
                    <div className="inline-flex items-center p-3 rounded-full gap-5 group-hover:bg-[color:var(--background-third)] transition-colors">
                    <div className="w-[1.641rem] h-[1.641rem] relative">
                        <svg className="h-[1.641rem]"
                            viewBox="0 0 24 24">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] rounded-xl shadow-box overflow-hidden">
                <button className="px-4 w-full h-14 inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)] transition-colors">
                    <div className="w-[1.641rem] h-[1.641rem] relative">
                ...
                <div className="h-px w-[89%] bg-[color:var(--background-third)] my-0.5 mx-auto"/>

                <Disclosure>
                    {({open}) => (
                        <>
                        <Disclosure.Button className="w-full p-4 flex justify-between items-center font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
                            Creator Studio
                        ...
                        <Disclosure.Panel>
                            <Link to="/" className="h-11 flex items-center px-3 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors">
                                <svg className="h-[1.172rem]"
                                    viewBox="0 0 24 24">
                    ...
                    {({open}) => (
                        ...
                        <Disclosure.Panel>
                            ...
                            <button
                                ...
                                className="h-11 flex items-center w-full px-3 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors"
                            >
                                <svg className="h-[1.172rem]"
                                    viewBox="0 0 24 24">
