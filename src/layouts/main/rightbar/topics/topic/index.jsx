    ...
    return (
        ...
        >
            ...
            <Popover className='absolute top-1.5 right-2'>
                ...
                <Popover.Panel className="w-[24rem] grid absolute top-2 right-0 bg-[color:var(--background-primary)] rounded-xl shadow-box overflow-hidden z-[2]">
                    <button
                        type="button"
                        className="text-left py-3 px-4 hover:bg-[color:var(--background-secondary)] transition-colors flex items-center gap-3 font-bold leading-5"
                    >
                        <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            <path
                                fill="currentColor" 
