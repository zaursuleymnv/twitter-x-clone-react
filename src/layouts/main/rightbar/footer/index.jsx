...
export default function Footer() {
    return (
        <footer className="mb-4 px-4 text-[0.813rem] flex flex-wrap gap-2">
            ...
            <div className="inline-flex gap-2 flex-wrap">
                <Popover className='relative inline-flex leading-4'>
                        <Popover.Button
                            className="text-[color:var(--color-base-secondary)] leading-4 hover:underline outline-none inline-flex items-center"
                        >
                            More
                            <svg 
                                viewBox="0 0 24 24"
                        ...
                        <Popover.Panel className='absolute bottom-0 right-0 w-[9.375rem] max-w-[24rem]  grid bg-[color:var(--background-primary)] shadow-box rounded-xl overflow-hidden'>
                            <Link to='/' className="py-3 px-4 font-bold leading-5 hover:bg-[color:var(--background-secondary)] transition-colors">
                                About
                            </Link>
                            <Link to='/' className="py-3 px-4 font-bold leading-5 hover:bg-[color:var(--background-secondary)] transition-colors">
                                Download the X app
