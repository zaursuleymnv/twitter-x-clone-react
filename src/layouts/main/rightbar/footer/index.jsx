    ...
    return (
        <footer className="mb-4 px-4 flex flex-wrap gap-2">
            ...
            <Popover className='relative inline-flex leading-4'>
                    ...
                    <Popover.Panel className='absolute bottom-0 right-0 w-[150px] max-w-[384px] grid bg-black shadow-box rounded-xl overflow-hidden'>
                        <Link to='/' className="py-3 px-4 text-white text-[15px] font-bold leading-5 hover:bg-[#16181c] transition-colors">
                            About
                        </Link>
                        <Link to='/' className="py-3 px-4 text-white text-[15px] font-bold leading-5 hover:bg-[#16181c] transition-colors">
                            Download the X app
