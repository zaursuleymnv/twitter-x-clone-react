        ...
        <div className="mt-3 grid gap-1">
            {!poll.voted && poll.answers.map((answer) => (
                    <button
                        ...
                        className="h-8 border border-[color:var(--color-primary)] text-[color:var(--color-primary)] font-bold rounded-full hover:bg-[color:var(--color-primary-alpha)] transition-colors" 
                        key={answer.id}
                    >
                        {answer.text}
                    </button>
            ...
            {poll.voted && poll.answers.map((answer) => (
                        <div className="h-8 flex items-center justify-between relative rounded-md px-2 overflow-hidden z-[1]">
                            <div
