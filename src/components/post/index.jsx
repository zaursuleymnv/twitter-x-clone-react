...
export default function Post({post}) {
    return (
        <div className="px-4 py-3 border-b border-[color:var(--background-third)] flex gap-3 relative before:absolute before:inset-0 before:z-[-1] before:hover:bg-[color:var(--background-secondary)] before:opacity-50 before:transition-colors">
            <img src={post.account.avatar} className="w-10 h-10 rounded-full object-cover" alt="" />
            <div className="flex-1">
                <header className="flex items-center gap-2 mb-0.5 leading-5">
                ...
                <div className="flex -ml-1.5 mt-2">
                    <div className="flex items-center flex-1 group gap-px">
                        ...
                        <span className="text-[0.813rem] text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0] transition-colors">{numberFormat(post.stats.comments)}</span>
                    </div>
